...
public:
    ...
    void SetMinVoltage(uint16_t min_voltage, uint8_t min_voltage_index) {
        ...
        ErrorCheck(Status::Undervoltage, this->min_voltage < kMinVoltage);
#endif
    }

    void SetMaxVoltage(uint16_t max_voltage, uint8_t max_voltage_index) {
    ...
    void SetMinTemp(int16_t min_temp, uint8_t min_temp_index) {
    ...
    void SetMaxTemp(int16_t max_temp, uint8_t max_temp_index) {
    ...
    void SetSumOfCells(uint16_t soc) {
        // TODO: sum_of_cells on Atmel was being divided by 10000
        sum_of_cells = soc;
    ...
    uint8_t min_voltage_index = 0;
    uint8_t max_voltage_index = 0;
    uint16_t sum_of_cells = 0;

    int16_t min_temp = 0;
    int16_t max_temp = 0;
    uint8_t min_temp_index = 0;
